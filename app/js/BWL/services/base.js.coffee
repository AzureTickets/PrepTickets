console?.warn "Can't use BWL.Services without BWL module loaded" unless BWL?

BWL.Services = {} unless BWL.Services?

class @BWL.Services.Account 
...
class @BWL.Services.MediaLibrary 
...
class @BWL.Services.SearchIndex 
