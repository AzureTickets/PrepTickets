module MyTagHelper
  ...
  def stylesheet_tag(source, options={})
    tag("link", { "rel" => "stylesheet", "type" => "text/css", "media" => "screen", "href" => source }.merge(options.stringify_keys), false)
  end
  def javascript_tag(source, options={})
    content_tag("script", "", { "type" => "text/javascript", "src" => source }.merge(options.stringify_keys))
  end
